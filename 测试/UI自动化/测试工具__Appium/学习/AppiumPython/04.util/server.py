...
class Server:
	...
	def create_command_list(self,i):
		...
		command = "appium -p "+str(appium_port_list[i])+" -bp "+str(bootstrap_port_list[i])+" -U "+device_list[i]+" --no-reset --session-override --log F:/GIT文件/mystudy/学习资料/编程与测试/测试工具__Appium/学习/AppiumPython/10.log/detail_log.log"

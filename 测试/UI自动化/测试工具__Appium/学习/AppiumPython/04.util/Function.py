...
class Element():
	...
	def get_element(self):
		try:
			...
			Log().warning("元素："+str(self.locator)+"，定位失败！")
			return None
	...
	def click(self):
		...
		"""
		Log().info("点击元素："+str(self.locator))
	...
	def send_keys(self,value):
		...
		"""
		Log().info("元素："+str(self.locator)+"，输入："+str(value))
		element=self.get_element()
		if element!=None:
...
if __name__=="__main__":
	...
	ll=list()
	for i in [By.ID,By.CLASS_NAME,By.XPATH,By.NAME,By.TAG_NAME,By.CSS_SELECTOR,By.LINK_TEXT,\
		By.ANDROID_UIAUTOMATOR]:
		ll.append(i)
	print(ll)

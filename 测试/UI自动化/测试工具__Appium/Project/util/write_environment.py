#coding=utf-8
"""
一个线程中测试集合的环境变量值操作，可以增、删、查、改运行的环境变量值，以yaml文件的形式管理，yaml文件
...
import yaml,os,multiprocessing,chardet
...
class Environment:
	...
	path="../temp/testsuite_tempdata/"+"testsuite"+"-pid-"+str(pid)
	...
	def set(self,para,value,path=None):
		"""同add()"""
		if path==None:
			path=self.path

...
class ATQtest(unittest.TestCase):
    ...
    def test_21_entrace(self):
        F.find_element(P.用户名输入框).send_keys("nishiwode")
        print(21)


    def test_22_entrace(self):
        F.add("123")
        print(22)
...
if __name__ == "__main__":
    ...
    suite.addTest(ATQtest('test_21_entrace'))#添加案例，访问网址
    suite.addTest(ATQtest('test_22_entrace'))#添加案例，访问网址

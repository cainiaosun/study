rem-调试数据
	Environment("Type")="额度业务"rem-业务类型：额度业务、单笔业务
	...
	Environment("CustomerName")="测试修改"rem-客户名称
	...
	Environment("AccountNo")="010001230900006074"'rem*入账账户
	Environment("ReAccountNoName")="测试修改"'rem*还款账户账户名
	Environment("ReAccountNo")="010001230900006074"rem*还款账户
...
RunAction "授信额度基本信息", oneIteration

...
Set Object=Browser("合同管理").Window("信贷风险管理系统V7").Page("信贷风险管理系统V7").Frame("myiframe0")
	...
	Element(Object,"贷款是否投向工业转型升级项目","WebList",0,0).Select	"是"
	Element(Object,"贷款是否投向战略新兴产业","WebList",0,0).Select		"新一代信息技术"
	Element(Object,"贷款是否投向文化产业","WebList",0,0).Select			"是"

...
rem'面签阶段
LoadAndRunAction Path,"1.0、新增面签",oneIteration
rem-LoadAndRunAction Path,"1.1、信用评估",oneIteration
rem-LoadAndRunAction Path,"1.2、发起面签",oneIteration
...
t=timer
Call Login("008250")
Environment.Value("Grained")="二级审批师岗"
LoadAndRunAction Path,"4、调整处理人", oneIteration
Call quit()
Call Login(Environment.Value("UserID"))

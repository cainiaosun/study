from base.web_ui import webdriver
#from base.web_ui.webdriver import Browser
...
class Element():
    ...
    def __init__(self, locator="", pattern=None):
        """
        参数：
        ...
        if isinstance(locator, str):
            if pattern:
                ...
                self.locator = getLocator().get("./case/page.xls")[locator]
    ...
    def find_element(self):
        ...
        return webdriver._driver.find_element(locator[0], locator[1])
    ...
    def scroll_into_view(self):
        ...
        webdriver._driver.execute_script("arguments[0].scrollIntoView();", element)
    ...
    def click_by_offset(self, xoffset=None, yoffset=None):
        ...
        if element:
            webdriver._driver.execute_script("arguments[0].scrollIntoView();", element)
            self.ActionChains(webdriver._driver).move_to_element_with_offset(element, xoffset, yoffset)\
                .click().perform()
    ...
    def click_by_js(self):
        ...
        webdriver._driver.execute_script(js)
    ...
    def highlight(self):
        # 高亮元素
        element = self.element()
        webdriver._driver.execute_script("arguments[0].setAttribute('style',arguments[1]);",
    ...
    def exist(self, timeout=10, poll_frequency=0.5):
        ...
        '''
        locator = self.locator
        from selenium.web_driver.support.wait import Web_driverWait
        from selenium.web_driver.support import expected_conditions as EC
        try:
...
if __name__=="__main__":
    ...
    print('this is :',webdriver._driver)
    #webdriver.Browser().goto('http://www.baidu.com')
    Element(('ip','kw')).highlight()